...
namespace SecureDesk.Algorithms
{
    class PasswordGenerator
    {
        ...
        static string temp = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789@#$&";
            
        private char[] pwdCharArray = temp.ToCharArray();
